...
static constexpr auto qt_meta_stringdata_ZN7loggingE = QtMocHelpers::stringData(
    "logging"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7loggingE[] = {
...
Q_CONSTINIT const QMetaObject logging::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7loggingE.offsetsAndSizes,
    qt_meta_data_ZN7loggingE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7loggingE_t,
        // Q_OBJECT / Q_GADGET
...
void *logging::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7loggingE.stringdata0))
